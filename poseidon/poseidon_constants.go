...
var FAST_PARTIAL_ROUND_W_HATS_VARS = [N_PARTIAL_ROUNDS][11]frontend.Variable{
	{
		frontend.Variable(uint64(uint64(0x3d999c961b7c63b0))),
		frontend.Variable(uint64(uint64(0x814e82efcd172529))),
		frontend.Variable(uint64(uint64(0x2421e5d236704588))),
		frontend.Variable(uint64(uint64(0x887af7d4dd482328))),
		frontend.Variable(uint64(uint64(0xa5e9c291f6119b27))),
		frontend.Variable(uint64(uint64(0xbdc52b2676a4b4aa))),
		frontend.Variable(uint64(uint64(0x64832009d29bcf57))),
		frontend.Variable(uint64(uint64(0x09c4155174a552cc))),
		frontend.Variable(uint64(uint64(0x463f9ee03d290810))),
		frontend.Variable(uint64(uint64(0xc810936e64982542))),
		frontend.Variable(uint64(uint64(0x043b1c289f7bc3ac))),
	},
	{
		frontend.Variable(uint64(uint64(0x673655aae8be5a8b))),
		frontend.Variable(uint64(uint64(0xd510fe714f39fa10))),
		frontend.Variable(uint64(uint64(0x2c68a099b51c9e73))),
		frontend.Variable(uint64(uint64(0xa667bfa9aa96999d))),
		frontend.Variable(uint64(uint64(0x4d67e72f063e2108))),
		frontend.Variable(uint64(uint64(0xf84dde3e6acda179))),
		frontend.Variable(uint64(uint64(0x40f9cc8c08f80981))),
		frontend.Variable(uint64(uint64(0x5ead032050097142))),
		frontend.Variable(uint64(uint64(0x6591b02092d671bb))),
		frontend.Variable(uint64(uint64(0x00e18c71963dd1b7))),
		frontend.Variable(uint64(uint64(0x8a21bcd24a14218a))),
	},
	{
		frontend.Variable(uint64(uint64(0x202800f4addbdc87))),
		frontend.Variable(uint64(uint64(0xe4b5bdb1cc3504ff))),
		frontend.Variable(uint64(uint64(0xbe32b32a825596e7))),
		frontend.Variable(uint64(uint64(0x8e0f68c5dc223b9a))),
		frontend.Variable(uint64(uint64(0x58022d9e1c256ce3))),
		frontend.Variable(uint64(uint64(0x584d29227aa073ac))),
		frontend.Variable(uint64(uint64(0x8b9352ad04bef9e7))),
		frontend.Variable(uint64(uint64(0xaead42a3f445ecbf))),
		frontend.Variable(uint64(uint64(0x3c667a1d833a3cca))),
		frontend.Variable(uint64(uint64(0xda6f61838efa1ffe))),
		frontend.Variable(uint64(uint64(0xe8f749470bd7c446))),
	},
	{
		frontend.Variable(uint64(uint64(0xc5b85bab9e5b3869))),
		frontend.Variable(uint64(uint64(0x45245258aec51cf7))),
		frontend.Variable(uint64(uint64(0x16e6b8e68b931830))),
		frontend.Variable(uint64(uint64(0xe2ae0f051418112c))),
		frontend.Variable(uint64(uint64(0x0470e26a0093a65b))),
		frontend.Variable(uint64(uint64(0x6bef71973a8146ed))),
		frontend.Variable(uint64(uint64(0x119265be51812daf))),
		frontend.Variable(uint64(uint64(0xb0be7356254bea2e))),
		frontend.Variable(uint64(uint64(0x8584defff7589bd7))),
		frontend.Variable(uint64(uint64(0x3c5fe4aeb1fb52ba))),
		frontend.Variable(uint64(uint64(0x9e7cd88acf543a5e))),
	},
	{
		frontend.Variable(uint64(uint64(0x179be4bba87f0a8c))),
		frontend.Variable(uint64(uint64(0xacf63d95d8887355))),
		frontend.Variable(uint64(uint64(0x6696670196b0074f))),
		frontend.Variable(uint64(uint64(0xd99ddf1fe75085f9))),
		frontend.Variable(uint64(uint64(0xc2597881fef0283b))),
		frontend.Variable(uint64(uint64(0xcf48395ee6c54f14))),
		frontend.Variable(uint64(uint64(0x15226a8e4cd8d3b6))),
		frontend.Variable(uint64(uint64(0xc053297389af5d3b))),
		frontend.Variable(uint64(uint64(0x2c08893f0d1580e2))),
		frontend.Variable(uint64(uint64(0x0ed3cbcff6fcc5ba))),
		frontend.Variable(uint64(uint64(0xc82f510ecf81f6d0))),
	},
	{
		frontend.Variable(uint64(uint64(0x94b06183acb715cc))),
		frontend.Variable(uint64(uint64(0x500392ed0d431137))),
		frontend.Variable(uint64(uint64(0x861cc95ad5c86323))),
		frontend.Variable(uint64(uint64(0x05830a443f86c4ac))),
		frontend.Variable(uint64(uint64(0x3b68225874a20a7c))),
		frontend.Variable(uint64(uint64(0x10b3309838e236fb))),
		frontend.Variable(uint64(uint64(0x9b77fc8bcd559e2c))),
		frontend.Variable(uint64(uint64(0xbdecf5e0cb9cb213))),
		frontend.Variable(uint64(uint64(0x30276f1221ace5fa))),
		frontend.Variable(uint64(uint64(0x7935dd342764a144))),
		frontend.Variable(uint64(uint64(0xeac6db520bb03708))),
	},
	{
		frontend.Variable(uint64(uint64(0x7186a80551025f8f))),
		frontend.Variable(uint64(uint64(0x622247557e9b5371))),
		frontend.Variable(uint64(uint64(0xc4cbe326d1ad9742))),
		frontend.Variable(uint64(uint64(0x55f1523ac6a23ea2))),
		frontend.Variable(uint64(uint64(0xa13dfe77a3d52f53))),
		frontend.Variable(uint64(uint64(0xe30750b6301c0452))),
		frontend.Variable(uint64(uint64(0x08bd488070a3a32b))),
		frontend.Variable(uint64(uint64(0xcd800caef5b72ae3))),
		frontend.Variable(uint64(uint64(0x83329c90f04233ce))),
		frontend.Variable(uint64(uint64(0xb5b99e6664a0a3ee))),
		frontend.Variable(uint64(uint64(0x6b0731849e200a7f))),
	},
	{
		frontend.Variable(uint64(uint64(0xec3fabc192b01799))),
		frontend.Variable(uint64(uint64(0x382b38cee8ee5375))),
		frontend.Variable(uint64(uint64(0x3bfb6c3f0e616572))),
		frontend.Variable(uint64(uint64(0x514abd0cf6c7bc86))),
		frontend.Variable(uint64(uint64(0x47521b1361dcc546))),
		frontend.Variable(uint64(uint64(0x178093843f863d14))),
		frontend.Variable(uint64(uint64(0xad1003c5d28918e7))),
		frontend.Variable(uint64(uint64(0x738450e42495bc81))),
		frontend.Variable(uint64(uint64(0xaf947c59af5e4047))),
		frontend.Variable(uint64(uint64(0x4653fb0685084ef2))),
		frontend.Variable(uint64(uint64(0x057fde2062ae35bf))),
	},
	{
		frontend.Variable(uint64(uint64(0xe376678d843ce55e))),
		frontend.Variable(uint64(uint64(0x66f3860d7514e7fc))),
		frontend.Variable(uint64(uint64(0x7817f3dfff8b4ffa))),
		frontend.Variable(uint64(uint64(0x3929624a9def725b))),
		frontend.Variable(uint64(uint64(0x0126ca37f215a80a))),
		frontend.Variable(uint64(uint64(0xfce2f5d02762a303))),
		frontend.Variable(uint64(uint64(0x1bc927375febbad7))),
		frontend.Variable(uint64(uint64(0x85b481e5243f60bf))),
		frontend.Variable(uint64(uint64(0x2d3c5f42a39c91a0))),
		frontend.Variable(uint64(uint64(0x0811719919351ae8))),
		frontend.Variable(uint64(uint64(0xf669de0add993131))),
	},
	{
		frontend.Variable(uint64(uint64(0x7de38bae084da92d))),
		frontend.Variable(uint64(uint64(0x5b848442237e8a9b))),
		frontend.Variable(uint64(uint64(0xf6c705da84d57310))),
		frontend.Variable(uint64(uint64(0x31e6a4bdb6a49017))),
		frontend.Variable(uint64(uint64(0x889489706e5c5c0f))),
		frontend.Variable(uint64(uint64(0x0e4a205459692a1b))),
		frontend.Variable(uint64(uint64(0xbac3fa75ee26f299))),
		frontend.Variable(uint64(uint64(0x5f5894f4057d755e))),
		frontend.Variable(uint64(uint64(0xb0dc3ecd724bb076))),
		frontend.Variable(uint64(uint64(0x5e34d8554a6452ba))),
		frontend.Variable(uint64(uint64(0x04f78fd8c1fdcc5f))),
	},
	{
		frontend.Variable(uint64(uint64(0x4dd19c38779512ea))),
		frontend.Variable(uint64(uint64(0xdb79ba02704620e9))),
		frontend.Variable(uint64(uint64(0x92a29a3675a5d2be))),
		frontend.Variable(uint64(uint64(0xd5177029fe495166))),
		frontend.Variable(uint64(uint64(0xd32b3298a13330c1))),
		frontend.Variable(uint64(uint64(0x251c4a3eb2c5f8fd))),
		frontend.Variable(uint64(uint64(0xe1c48b26e0d98825))),
		frontend.Variable(uint64(uint64(0x3301d3362a4ffccb))),
		frontend.Variable(uint64(uint64(0x09bb6c88de8cd178))),
		frontend.Variable(uint64(uint64(0xdc05b676564f538a))),
		frontend.Variable(uint64(uint64(0x60192d883e473fee))),
	},
	{
		frontend.Variable(uint64(uint64(0x16b9774801ac44a0))),
		frontend.Variable(uint64(uint64(0x3cb8411e786d3c8e))),
		frontend.Variable(uint64(uint64(0xa86e9cf505072491))),
		frontend.Variable(uint64(uint64(0x0178928152e109ae))),
		frontend.Variable(uint64(uint64(0x5317b905a6e1ab7b))),
		frontend.Variable(uint64(uint64(0xda20b3be7f53d59f))),
		frontend.Variable(uint64(uint64(0xcb97dedecebee9ad))),
		frontend.Variable(uint64(uint64(0x4bd545218c59f58d))),
		frontend.Variable(uint64(uint64(0x77dc8d856c05a44a))),
		frontend.Variable(uint64(uint64(0x87948589e4f243fd))),
		frontend.Variable(uint64(uint64(0x7e5217af969952c2))),
	},
	{
		frontend.Variable(uint64(uint64(0xbc58987d06a84e4d))),
		frontend.Variable(uint64(uint64(0x0b5d420244c9cae3))),
		frontend.Variable(uint64(uint64(0xa3c4711b938c02c0))),
		frontend.Variable(uint64(uint64(0x3aace640a3e03990))),
		frontend.Variable(uint64(uint64(0x865a0f3249aacd8a))),
		frontend.Variable(uint64(uint64(0x8d00b2a7dbed06c7))),
		frontend.Variable(uint64(uint64(0x6eacb905beb7e2f8))),
		frontend.Variable(uint64(uint64(0x045322b216ec3ec7))),
		frontend.Variable(uint64(uint64(0xeb9de00d594828e6))),
		frontend.Variable(uint64(uint64(0x088c5f20df9e5c26))),
		frontend.Variable(uint64(uint64(0xf555f4112b19781f))),
	},
	{
		frontend.Variable(uint64(uint64(0xa8cedbff1813d3a7))),
		frontend.Variable(uint64(uint64(0x50dcaee0fd27d164))),
		frontend.Variable(uint64(uint64(0xf1cb02417e23bd82))),
		frontend.Variable(uint64(uint64(0xfaf322786e2abe8b))),
		frontend.Variable(uint64(uint64(0x937a4315beb5d9b6))),
		frontend.Variable(uint64(uint64(0x1b18992921a11d85))),
		frontend.Variable(uint64(uint64(0x7d66c4368b3c497b))),
		frontend.Variable(uint64(uint64(0x0e7946317a6b4e99))),
		frontend.Variable(uint64(uint64(0xbe4430134182978b))),
		frontend.Variable(uint64(uint64(0x3771e82493ab262d))),
		frontend.Variable(uint64(uint64(0xa671690d8095ce82))),
	},
	{
		frontend.Variable(uint64(uint64(0xb035585f6e929d9d))),
		frontend.Variable(uint64(uint64(0xba1579c7e219b954))),
		frontend.Variable(uint64(uint64(0xcb201cf846db4ba3))),
		frontend.Variable(uint64(uint64(0x287bf9177372cf45))),
		frontend.Variable(uint64(uint64(0xa350e4f61147d0a6))),
		frontend.Variable(uint64(uint64(0xd5d0ecfb50bcff99))),
		frontend.Variable(uint64(uint64(0x2e166aa6c776ed21))),
		frontend.Variable(uint64(uint64(0xe1e66c991990e282))),
		frontend.Variable(uint64(uint64(0x662b329b01e7bb38))),
		frontend.Variable(uint64(uint64(0x8aa674b36144d9a9))),
		frontend.Variable(uint64(uint64(0xcbabf78f97f95e65))),
	},
	{
		frontend.Variable(uint64(uint64(0xeec24b15a06b53fe))),
		frontend.Variable(uint64(uint64(0xc8a7aa07c5633533))),
		frontend.Variable(uint64(uint64(0xefe9c6fa4311ad51))),
		frontend.Variable(uint64(uint64(0xb9173f13977109a1))),
		frontend.Variable(uint64(uint64(0x69ce43c9cc94aedc))),
		frontend.Variable(uint64(uint64(0xecf623c9cd118815))),
		frontend.Variable(uint64(uint64(0x28625def198c33c7))),
		frontend.Variable(uint64(uint64(0xccfc5f7de5c3636a))),
		frontend.Variable(uint64(uint64(0xf5e6c40f1621c299))),
		frontend.Variable(uint64(uint64(0xcec0e58c34cb64b1))),
		frontend.Variable(uint64(uint64(0xa868ea113387939f))),
	},
	{
		frontend.Variable(uint64(uint64(0xd8dddbdc5ce4ef45))),
		frontend.Variable(uint64(uint64(0xacfc51de8131458c))),
		frontend.Variable(uint64(uint64(0x146bb3c0fe499ac0))),
		frontend.Variable(uint64(uint64(0x9e65309f15943903))),
		frontend.Variable(uint64(uint64(0x80d0ad980773aa70))),
		frontend.Variable(uint64(uint64(0xf97817d4ddbf0607))),
		frontend.Variable(uint64(uint64(0xe4626620a75ba276))),
		frontend.Variable(uint64(uint64(0x0dfdc7fd6fc74f66))),
		frontend.Variable(uint64(uint64(0xf464864ad6f2bb93))),
		frontend.Variable(uint64(uint64(0x02d55e52a5d44414))),
		frontend.Variable(uint64(uint64(0xdd8de62487c40925))),
	},
	{
		frontend.Variable(uint64(uint64(0xc15acf44759545a3))),
		frontend.Variable(uint64(uint64(0xcbfdcf39869719d4))),
		frontend.Variable(uint64(uint64(0x33f62042e2f80225))),
		frontend.Variable(uint64(uint64(0x2599c5ead81d8fa3))),
		frontend.Variable(uint64(uint64(0x0b306cb6c1d7c8d0))),
		frontend.Variable(uint64(uint64(0x658c80d3df3729b1))),
		frontend.Variable(uint64(uint64(0xe8d1b2b21b41429c))),
		frontend.Variable(uint64(uint64(0xa1b67f09d4b3ccb8))),
		frontend.Variable(uint64(uint64(0x0e1adf8b84437180))),
		frontend.Variable(uint64(uint64(0x0d593a5e584af47b))),
		frontend.Variable(uint64(uint64(0xa023d94c56e151c7))),
	},
	{
		frontend.Variable(uint64(uint64(0x49026cc3a4afc5a6))),
		frontend.Variable(uint64(uint64(0xe06dff00ab25b91b))),
		frontend.Variable(uint64(uint64(0x0ab38c561e8850ff))),
		frontend.Variable(uint64(uint64(0x92c3c8275e105eeb))),
		frontend.Variable(uint64(uint64(0xb65256e546889bd0))),
		frontend.Variable(uint64(uint64(0x3c0468236ea142f6))),
		frontend.Variable(uint64(uint64(0xee61766b889e18f2))),
		frontend.Variable(uint64(uint64(0xa206f41b12c30415))),
		frontend.Variable(uint64(uint64(0x02fe9d756c9f12d1))),
		frontend.Variable(uint64(uint64(0xe9633210630cbf12))),
		frontend.Variable(uint64(uint64(0x1ffea9fe85a0b0b1))),
	},
	{
		frontend.Variable(uint64(uint64(0x81d1ae8cc50240f3))),
		frontend.Variable(uint64(uint64(0xf4c77a079a4607d7))),
		frontend.Variable(uint64(uint64(0xed446b2315e3efc1))),
		frontend.Variable(uint64(uint64(0x0b0a6b70915178c3))),
		frontend.Variable(uint64(uint64(0xb11ff3e089f15d9a))),
		frontend.Variable(uint64(uint64(0x1d4dba0b7ae9cc18))),
		frontend.Variable(uint64(uint64(0x65d74e2f43b48d05))),
		frontend.Variable(uint64(uint64(0xa2df8c6b8ae0804a))),
		frontend.Variable(uint64(uint64(0xa4e6f0a8c33348a6))),
		frontend.Variable(uint64(uint64(0xc0a26efc7be5669b))),
		frontend.Variable(uint64(uint64(0xa6b6582c547d0d60))),
	},
	{
		frontend.Variable(uint64(uint64(0x84afc741f1c13213))),
		frontend.Variable(uint64(uint64(0x2f8f43734fc906f3))),
		frontend.Variable(uint64(uint64(0xde682d72da0a02d9))),
		frontend.Variable(uint64(uint64(0x0bb005236adb9ef2))),
		frontend.Variable(uint64(uint64(0x5bdf35c10a8b5624))),
		frontend.Variable(uint64(uint64(0x0739a8a343950010))),
		frontend.Variable(uint64(uint64(0x52f515f44785cfbc))),
		frontend.Variable(uint64(uint64(0xcbaf4e5d82856c60))),
		frontend.Variable(uint64(uint64(0xac9ea09074e3e150))),
		frontend.Variable(uint64(uint64(0x8f0fa011a2035fb0))),
		frontend.Variable(uint64(uint64(0x1a37905d8450904a))),
	},
	{
		frontend.Variable(uint64(uint64(0x3abeb80def61cc85))),
		frontend.Variable(uint64(uint64(0x9d19c9dd4eac4133))),
		frontend.Variable(uint64(uint64(0x075a652d9641a985))),
		frontend.Variable(uint64(uint64(0x9daf69ae1b67e667))),
		frontend.Variable(uint64(uint64(0x364f71da77920a18))),
		frontend.Variable(uint64(uint64(0x50bd769f745c95b1))),
		frontend.Variable(uint64(uint64(0xf223d1180dbbf3fc))),
		frontend.Variable(uint64(uint64(0x2f885e584e04aa99))),
		frontend.Variable(uint64(uint64(0xb69a0fa70aea684a))),
		frontend.Variable(uint64(uint64(0x09584acaa6e062a0))),
		frontend.Variable(uint64(uint64(0x0bc051640145b19b))),
	},
}
